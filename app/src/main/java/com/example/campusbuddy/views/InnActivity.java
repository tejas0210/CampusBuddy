...
public class InnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = InnActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(InnActivity.this, R.color.arsenic));
...
//        Toast.makeText(this, "Here now", Toast.LENGTH_SHORT).show();
        ...
        reference = database.getReference("Inn");
        list = new ArrayList<>();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ServiceAdapter(list, InnActivity.this);
                binding.recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(InnActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
            }
        });
