...
import com.example.campusbuddy.databinding.ActivityPlayAreaBinding;
...
public class PlayAreaActivity extends AppCompatActivity {
    ActivityPlayAreaBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPlayAreaBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        Window window = PlayAreaActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(PlayAreaActivity.this, R.color.arsenic));
...
//        Toast.makeText(this, "Here now", Toast.LENGTH_SHORT).show();
        ...
        reference = database.getReference("Play Area");
        list = new ArrayList<>();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ServiceAdapter(list, PlayAreaActivity.this);
                binding.recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PlayAreaActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
            }
        });
