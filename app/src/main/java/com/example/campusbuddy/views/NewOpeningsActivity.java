...
import com.example.campusbuddy.databinding.ActivityNewOpeningsBinding;
...
public class NewOpeningsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = NewOpeningsActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(NewOpeningsActivity.this, R.color.arsenic));
...
//        Toast.makeText(this, "Here now", Toast.LENGTH_SHORT).show();
        ...
        reference = database.getReference("New Opening");
        list = new ArrayList<>();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ServiceAdapter(list, NewOpeningsActivity.this);
                binding.recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(NewOpeningsActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
            }
        });
