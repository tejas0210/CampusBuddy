...
import com.example.campusbuddy.databinding.ActivityCollegeClubsBinding;
...
public class CollegeClubsActivity extends AppCompatActivity {
    ActivityCollegeClubsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCollegeClubsBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        Window window = CollegeClubsActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(CollegeClubsActivity.this, R.color.arsenic));
        // assigning ID of the toolbar to a variable
        Toolbar toolbar = findViewById(R.id.toolbar);
        // using toolbar as ActionBar
        setSupportActionBar(toolbar);
        setTitle("College Clubs");
...
//        Toast.makeText(this, "Here now", Toast.LENGTH_SHORT).show();
        ...
        reference = database.getReference("College Clubs");
        list = new ArrayList<>();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ServiceAdapter(list, CollegeClubsActivity.this);
                binding.recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CollegeClubsActivity.this, "Error!!", Toast.LENGTH_SHORT).show();
            }
        });
