...
import com.example.campusbuddy.databinding.ActivityTransportBinding;
...
public class TransportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = TransportActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(TransportActivity.this, R.color.arsenic));
...
//        Toast.makeText(this, "Here now", Toast.LENGTH_SHORT).show();
        ...
        reference = database.getReference("Transport");
        list = new ArrayList<>();
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ServiceAdapter(list, TransportActivity.this);
